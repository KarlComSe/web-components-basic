class WcMain extends HTMLElement {
    ...
    connectedCallback() {
        ...
        shadowRoot.innerHTML = `
            ...
            <p>The <span class="blue">slot</span> is styled with a local stylesheet, defined
             through slot[name="title"]. Furthermore, it utilize ::slotted(span) to make an
              underline, it would also work with ::slotted(*).</p>
            <slot></slot>
            </div>
        `;
    }
